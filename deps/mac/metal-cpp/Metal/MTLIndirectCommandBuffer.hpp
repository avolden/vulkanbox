...
{
	return Object::sendMessage<MTL::IndirectCommandType>(this,
	                                                     _MTL_PRIVATE_SEL(commandTypes));
}
			...
			MTL::IndirectCommandBufferDescriptor::maxKernelBufferBindCount() const
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(maxKernelBufferBindCount));
}

_MTL_INLINE NS::UInteger
MTL::IndirectCommandBufferDescriptor::maxKernelThreadgroupMemoryBindCount() const
{
	return Object::sendMessage<NS::UInteger>(
...
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(maxMeshBufferBindCount));
}
...
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(maxObjectBufferBindCount));
}

_MTL_INLINE NS::UInteger
MTL::IndirectCommandBufferDescriptor::maxObjectThreadgroupMemoryBindCount() const
{
	return Object::sendMessage<NS::UInteger>(
...
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(maxVertexBufferBindCount));
}
...
_MTL_INLINE void
MTL::IndirectCommandBufferDescriptor::setInheritCullMode(bool inheritCullMode)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setInheritCullMode_),
	                          inheritCullMode);
}

_MTL_INLINE void
MTL::IndirectCommandBufferDescriptor::setInheritDepthBias(bool inheritDepthBias)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setInheritDepthBias_),
	                          inheritDepthBias);
}

_MTL_INLINE void
MTL::IndirectCommandBufferDescriptor::setInheritDepthClipMode(bool inheritDepthClipMode)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setInheritDepthClipMode_),
...
_MTL_INLINE void
MTL::IndirectCommandBufferDescriptor::setInheritPipelineState(bool inheritPipelineState)
{
	...
	NS::UInteger maxKernelThreadgroupMemoryBindCount)
{
	Object::sendMessage<void>(this,
	                          _MTL_PRIVATE_SEL(setMaxKernelThreadgroupMemoryBindCount_),
...
{
	Object::sendMessage<void>(this,
	                          _MTL_PRIVATE_SEL(setMaxObjectThreadgroupMemoryBindCount_),
...
_MTL_INLINE void
MTL::IndirectCommandBufferDescriptor::setSupportRayTracing(bool supportRayTracing)
{
...
_MTL_INLINE bool
MTL::IndirectCommandBufferDescriptor::supportColorAttachmentMapping() const
{
...
{
	return Object::sendMessageSafe<bool>(this,
	                                     _MTL_PRIVATE_SEL(supportDynamicAttributeStride));
}

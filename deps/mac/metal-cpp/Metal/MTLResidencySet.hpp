...
namespace MTL
{
	...
	{
	public:
		void addAllocation(MTL::Allocation const* allocation);
		void addAllocations(MTL::Allocation const* const allocations[],
		                    NS::UInteger                 count);
		...
		bool containsAllocation(MTL::Allocation const* anAllocation);
		...
		void removeAllocation(MTL::Allocation const* allocation);
		void removeAllocations(MTL::Allocation const* const allocations[],
		                       NS::UInteger                 count);
...
_MTL_INLINE void
MTL::ResidencySetDescriptor::setInitialCapacity(NS::UInteger initialCapacity)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setInitialCapacity_),
	                          initialCapacity);
}

_MTL_INLINE void MTL::ResidencySetDescriptor::setLabel(NS::String const* label)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setLabel_), label);
}

_MTL_INLINE void MTL::ResidencySet::addAllocation(MTL::Allocation const* allocation)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(addAllocation_), allocation);
}

_MTL_INLINE void MTL::ResidencySet::addAllocations(
	MTL::Allocation const* const allocations[], NS::UInteger count)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(addAllocations_count_), allocations,
	                          count);
}
...
_MTL_INLINE bool
MTL::ResidencySet::containsAllocation(MTL::Allocation const* anAllocation)
{
	return Object::sendMessage<bool>(this, _MTL_PRIVATE_SEL(containsAllocation_),
	                                 anAllocation);
}
...
_MTL_INLINE void MTL::ResidencySet::removeAllocation(MTL::Allocation const* allocation)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(removeAllocation_), allocation);
}

_MTL_INLINE void MTL::ResidencySet::removeAllocations(
	MTL::Allocation const* const allocations[], NS::UInteger count)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(removeAllocations_count_),
	                          allocations, count);
}

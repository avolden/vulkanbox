...
namespace MTL
{
	...
	public:
		...
		void setBackFaceStencil(MTL::StencilDescriptor const* backFaceStencil);

		void setDepthCompareFunction(MTL::CompareFunction depthCompareFunction);

		void setDepthWriteEnabled(bool depthWriteEnabled);

		void setFrontFaceStencil(MTL::StencilDescriptor const* frontFaceStencil);
...
_MTL_INLINE void MTL::DepthStencilDescriptor::setBackFaceStencil(
	MTL::StencilDescriptor const* backFaceStencil)
{
...
_MTL_INLINE void MTL::DepthStencilDescriptor::setFrontFaceStencil(
	MTL::StencilDescriptor const* frontFaceStencil)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setFrontFaceStencil_),
	                          frontFaceStencil);
}

_MTL_INLINE void MTL::DepthStencilDescriptor::setLabel(NS::String const* label)
{

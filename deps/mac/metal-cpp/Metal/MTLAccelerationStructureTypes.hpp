...
#pragma clang diagnostic pop
	...
	{
		PackedFloat4x3();
		PackedFloat4x3(PackedFloat3 const& col0, PackedFloat3 const& col1,
		               PackedFloat3 const& col2, PackedFloat3 const& col3);

		PackedFloat3&       operator[](int idx);
		PackedFloat3 const& operator[](int idx) const;
...
_MTL_INLINE MTL::PackedFloat4x3::PackedFloat4x3(PackedFloat3 const& col0,
                                                PackedFloat3 const& col1,
                                                PackedFloat3 const& col2,
                                                PackedFloat3 const& col3)
{
	columns[0] = col0;
	columns[1] = col1;
	columns[2] = col2;
...
_MTL_INLINE MTL::PackedFloatQuaternion::PackedFloatQuaternion(float x, float y, float z,
                                                              float w)
: x(x)
, y(y)
, z(z)
...
_MTL_INLINE MTL4::BufferRange MTL4::BufferRange::Make(uint64_t bufferAddress,
                                                      uint64_t length)
{

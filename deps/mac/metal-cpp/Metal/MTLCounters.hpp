...
namespace MTL
{
	...
	static NS::UInteger const CounterErrorValue = static_cast<NS::UInteger>(~0ULL);
	static NS::UInteger const CounterDontSample = static_cast<NS::UInteger>(-1);
	...
	public:
		...
		void setCounterSet(MTL::CounterSet const* counterSet);
...
_MTL_PRIVATE_DEF_CONST(MTL::CommonCounter,
...
_MTL_INLINE void
MTL::CounterSampleBufferDescriptor::setCounterSet(MTL::CounterSet const* counterSet)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setCounterSet_), counterSet);
}

_MTL_INLINE void MTL::CounterSampleBufferDescriptor::setLabel(NS::String const* label)
{
...
_MTL_INLINE void
MTL::CounterSampleBufferDescriptor::setStorageMode(MTL::StorageMode storageMode)
{
...
{
	return Object::sendMessage<NS::Data*>(this, _MTL_PRIVATE_SEL(resolveCounterRange_),
	                                      range);
}

...
namespace MTL4
{
	...
	public:
		void buildAccelerationStructure(
			...
			MTL4::AccelerationStructureDescriptor const* descriptor,
			MTL4::BufferRange const                      scratchBuffer);

		void copyAccelerationStructure(
			MTL::AccelerationStructure const* sourceAccelerationStructure,
			MTL::AccelerationStructure const* destinationAccelerationStructure);

		void copyAndCompactAccelerationStructure(
			MTL::AccelerationStructure const* sourceAccelerationStructure,
			MTL::AccelerationStructure const* destinationAccelerationStructure);

		void copyFromBuffer(MTL::Buffer const* sourceBuffer, NS::UInteger sourceOffset,
		                    MTL::Buffer const* destinationBuffer,
		...
		void copyFromBuffer(MTL::Buffer const* sourceBuffer, NS::UInteger sourceOffset,
		                    ...
		                    MTL::Texture const* destinationTexture,
		...
		void copyFromTensor(MTL::Tensor const*        sourceTensor,
		                    MTL::TensorExtents const* sourceOrigin,
		                    MTL::TensorExtents const* sourceDimensions,
		                    MTL::Tensor const*        destinationTensor,
		                    MTL::TensorExtents const* destinationOrigin,
		                    MTL::TensorExtents const* destinationDimensions);

		void copyFromTexture(MTL::Texture const* sourceTexture,
		                     MTL::Texture const* destinationTexture);
		void copyFromTexture(MTL::Texture const* sourceTexture, NS::UInteger sourceSlice,
		...
		void copyFromTexture(MTL::Texture const* sourceTexture, NS::UInteger sourceSlice,
		                     ...
		                     MTL::Size sourceSize, MTL::Texture const* destinationTexture,
		                     NS::UInteger destinationSlice, NS::UInteger destinationLevel,
		                     MTL::Origin destinationOrigin);
		void copyFromTexture(MTL::Texture const* sourceTexture, NS::UInteger sourceSlice,
		                     NS::UInteger sourceLevel, MTL::Origin sourceOrigin,
		                     MTL::Size sourceSize, MTL::Buffer const* destinationBuffer,
		...
		void copyIndirectCommandBuffer(MTL::IndirectCommandBuffer const* source,
		                               NS::Range                         sourceRange,
		                               MTL::IndirectCommandBuffer const* destination,
		                               NS::UInteger destinationIndex);

		void dispatchThreadgroups(MTL::Size threadgroupsPerGrid,
		                          MTL::Size threadsPerThreadgroup);
		void dispatchThreadgroups(MTL::GPUAddress indirectBuffer,
		                          MTL::Size       threadsPerThreadgroup);
		...
		void fillBuffer(MTL::Buffer const* buffer, NS::Range range, uint8_t value);

		void generateMipmaps(MTL::Texture const* texture);

		void optimizeContentsForCPUAccess(MTL::Texture const* texture);
		void optimizeContentsForCPUAccess(MTL::Texture const* texture, NS::UInteger slice,
		                                  NS::UInteger level);

		void optimizeContentsForGPUAccess(MTL::Texture const* texture);
		void optimizeContentsForGPUAccess(MTL::Texture const* texture, NS::UInteger slice,
		                                  NS::UInteger level);

		void optimizeIndirectCommandBuffer(
			MTL::IndirectCommandBuffer const* indirectCommandBuffer, NS::Range range);
		...
		void resetCommandsInBuffer(MTL::IndirectCommandBuffer const* buffer,
		                           NS::Range                         range);

		void setArgumentTable(MTL4::ArgumentTable const* argumentTable);
		...
		void writeCompactedAccelerationStructureSize(
			MTL::AccelerationStructure const* accelerationStructure,
			MTL4::BufferRange const           buffer);

		void writeTimestamp(MTL4::TimestampGranularity granularity,
		                    MTL4::CounterHeap const* counterHeap, NS::UInteger index);
	};
	...
	MTL4::BufferRange const                      scratchBuffer)
{
	Object::sendMessage<void>(
		this, _MTL_PRIVATE_SEL(buildAccelerationStructure_descriptor_scratchBuffer_),
...
{
	Object::sendMessage<void>(
		this, _MTL_PRIVATE_SEL(copyAccelerationStructure_toAccelerationStructure_),
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::copyFromBuffer(
	MTL::Buffer const* sourceBuffer, NS::UInteger sourceOffset,
	MTL::Buffer const* destinationBuffer, NS::UInteger destinationOffset,
	NS::UInteger size)
{
	Object::sendMessage<void>(
		this,
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::copyFromTensor(
	MTL::Tensor const* sourceTensor, MTL::TensorExtents const* sourceOrigin,
	MTL::TensorExtents const* sourceDimensions, MTL::Tensor const* destinationTensor,
	MTL::TensorExtents const* destinationOrigin,
	MTL::TensorExtents const* destinationDimensions)
{
	Object::sendMessage<void>(
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::copyFromTexture(
	MTL::Texture const* sourceTexture, NS::UInteger sourceSlice, NS::UInteger sourceLevel,
	MTL::Texture const* destinationTexture, NS::UInteger destinationSlice,
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::copyFromTexture(
	MTL::Texture const* sourceTexture, NS::UInteger sourceSlice, NS::UInteger sourceLevel,
	MTL::Origin sourceOrigin, MTL::Size sourceSize, MTL::Buffer const* destinationBuffer,
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::copyIndirectCommandBuffer(
	MTL::IndirectCommandBuffer const* source, NS::Range sourceRange,
	MTL::IndirectCommandBuffer const* destination, NS::UInteger destinationIndex)
{
	Object::sendMessage<void>(
		this,
		_MTL_PRIVATE_SEL(
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::dispatchThreads(
...
_MTL_INLINE void
MTL4::ComputeCommandEncoder::dispatchThreads(MTL::GPUAddress indirectBuffer)
{
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::fillBuffer(MTL::Buffer const* buffer,
                                                         NS::Range range, uint8_t value)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(fillBuffer_range_value_), buffer,
	                          range, value);
}

_MTL_INLINE void MTL4::ComputeCommandEncoder::generateMipmaps(MTL::Texture const* texture)
{
...
_MTL_INLINE void
MTL4::ComputeCommandEncoder::optimizeContentsForCPUAccess(MTL::Texture const* texture)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(optimizeContentsForCPUAccess_),
	                          texture);
}

_MTL_INLINE void MTL4::ComputeCommandEncoder::optimizeContentsForCPUAccess(
	MTL::Texture const* texture, NS::UInteger slice, NS::UInteger level)
{
	Object::sendMessage<void>(this,
	                          _MTL_PRIVATE_SEL(optimizeContentsForCPUAccess_slice_level_),
	                          texture, slice, level);
}

_MTL_INLINE void
MTL4::ComputeCommandEncoder::optimizeContentsForGPUAccess(MTL::Texture const* texture)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(optimizeContentsForGPUAccess_),
	                          texture);
}
...
{
	Object::sendMessage<void>(this,
	                          _MTL_PRIVATE_SEL(optimizeContentsForGPUAccess_slice_level_),
	                          texture, slice, level);
}
	...
	MTL4::BufferRange const                      scratchBuffer)
{
	Object::sendMessage<void>(
		this,
		_MTL_PRIVATE_SEL(
			refitAccelerationStructure_descriptor_destination_scratchBuffer_),
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::refitAccelerationStructure(
	...
	MTL4::AccelerationStructureDescriptor const* descriptor,
	MTL::AccelerationStructure const*            destinationAccelerationStructure,
	MTL4::BufferRange const scratchBuffer, MTL::AccelerationStructureRefitOptions options)
{
	Object::sendMessage<void>(
		this,
		_MTL_PRIVATE_SEL(
		...
		sourceAccelerationStructure, descriptor, destinationAccelerationStructure,
		scratchBuffer, options);
}

_MTL_INLINE void MTL4::ComputeCommandEncoder::resetCommandsInBuffer(
	MTL::IndirectCommandBuffer const* buffer, NS::Range range)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(resetCommandsInBuffer_withRange_),
	                          buffer, range);
}

_MTL_INLINE void
MTL4::ComputeCommandEncoder::setArgumentTable(MTL4::ArgumentTable const* argumentTable)
{
...
_MTL_INLINE void MTL4::ComputeCommandEncoder::setThreadgroupMemoryLength(
...
{
	Object::sendMessage<void>(
		this, _MTL_PRIVATE_SEL(writeCompactedAccelerationStructureSize_toBuffer_),
		accelerationStructure, buffer);
}

_MTL_INLINE void MTL4::ComputeCommandEncoder::writeTimestamp(
	MTL4::TimestampGranularity granularity, MTL4::CounterHeap const* counterHeap,
	NS::UInteger index)
{
	Object::sendMessage<void>(
		this, _MTL_PRIVATE_SEL(writeTimestampWithGranularity_intoHeap_atIndex_),

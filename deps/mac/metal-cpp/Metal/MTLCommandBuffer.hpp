...
namespace MTL
{
	...
	using HandlerFunction = MtlCpp::Function<void(CommandBuffer*)>;
	...
	public:
		...
		void setLogState(MTL::LogState const* logState);
	...
	public:
		...
		AccelerationStructureCommandEncoder* accelerationStructureCommandEncoder(
			MTL::AccelerationStructurePassDescriptor const* descriptor);

		void addCompletedHandler(MTL::CommandBufferHandler const block);
		void addCompletedHandler(MTL::HandlerFunction const& function);

		void addScheduledHandler(MTL::CommandBufferHandler const block);
		void addScheduledHandler(MTL::HandlerFunction const& function);

		BlitCommandEncoder* blitCommandEncoder();
		BlitCommandEncoder*
		blitCommandEncoder(MTL::BlitPassDescriptor const* blitPassDescriptor);
		...
		computeCommandEncoder(MTL::ComputePassDescriptor const* computePassDescriptor);
		ComputeCommandEncoder* computeCommandEncoder();
		ComputeCommandEncoder* computeCommandEncoder(MTL::DispatchType dispatchType);

		Device* device() const;

		void encodeSignalEvent(MTL::Event const* event, uint64_t value);

		void encodeWait(MTL::Event const* event, uint64_t value);
		...
		ParallelRenderCommandEncoder* parallelRenderCommandEncoder(
			MTL::RenderPassDescriptor const* renderPassDescriptor);

		void popDebugGroup();

		void presentDrawable(MTL::Drawable const* drawable);
		void presentDrawableAfterMinimumDuration(MTL::Drawable const* drawable,
		                                         CFTimeInterval       duration);

		void presentDrawableAtTime(MTL::Drawable const* drawable,
		                           CFTimeInterval       presentationTime);

		void pushDebugGroup(NS::String const* string);

		RenderCommandEncoder*
		renderCommandEncoder(MTL::RenderPassDescriptor const* renderPassDescriptor);

		ResourceStateCommandEncoder* resourceStateCommandEncoder();
		ResourceStateCommandEncoder* resourceStateCommandEncoder(
			MTL::ResourceStatePassDescriptor const* resourceStatePassDescriptor);
		...
		void useResidencySet(MTL::ResidencySet const* residencySet);
		void useResidencySets(MTL::ResidencySet const* const residencySets[],
		                      NS::UInteger                   count);
...
_MTL_INLINE void
MTL::CommandBufferDescriptor::setErrorOptions(MTL::CommandBufferErrorOption errorOptions)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setErrorOptions_), errorOptions);
}

_MTL_INLINE void MTL::CommandBufferDescriptor::setLogState(MTL::LogState const* logState)
{
...
_MTL_INLINE void
MTL::CommandBuffer::addCompletedHandler(MTL::CommandBufferHandler const block)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(addCompletedHandler_), block);
}

_MTL_INLINE void
MTL::CommandBuffer::addCompletedHandler(MTL::HandlerFunction const& function)
{
...
_MTL_INLINE void
MTL::CommandBuffer::addScheduledHandler(MTL::CommandBufferHandler const block)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(addScheduledHandler_), block);
}

_MTL_INLINE void
MTL::CommandBuffer::addScheduledHandler(MTL::HandlerFunction const& function)
{
	__block HandlerFunction blockFunction = function;
...
MTL::CommandBuffer::blitCommandEncoder(MTL::BlitPassDescriptor const* blitPassDescriptor)
{
	return Object::sendMessage<MTL::BlitCommandEncoder*>(
...
_MTL_INLINE MTL::ComputeCommandEncoder* MTL::CommandBuffer::computeCommandEncoder(
	MTL::ComputePassDescriptor const* computePassDescriptor)
{
...
_MTL_INLINE void MTL::CommandBuffer::encodeSignalEvent(MTL::Event const* event,
                                                       uint64_t          value)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(encodeSignalEvent_value_), event,
	                          value);
}

_MTL_INLINE void MTL::CommandBuffer::encodeWait(MTL::Event const* event, uint64_t value)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(encodeWaitForEvent_value_), event,
	                          value);
}
...
_MTL_INLINE void MTL::CommandBuffer::presentDrawable(MTL::Drawable const* drawable)
{
...
_MTL_INLINE void MTL::CommandBuffer::presentDrawableAfterMinimumDuration(
	MTL::Drawable const* drawable, CFTimeInterval duration)
{
...
_MTL_INLINE void MTL::CommandBuffer::presentDrawableAtTime(
	MTL::Drawable const* drawable, CFTimeInterval presentationTime)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(presentDrawable_atTime_), drawable,
	                          presentationTime);
}

_MTL_INLINE void MTL::CommandBuffer::pushDebugGroup(NS::String const* string)
{
...
_MTL_INLINE void MTL::CommandBuffer::setLabel(NS::String const* label)
{
...
_MTL_INLINE void
MTL::CommandBuffer::useResidencySet(MTL::ResidencySet const* residencySet)
{
...
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(useResidencySets_count_),
	                          residencySets, count);
}

...
namespace MTL
{
	...
	using DrawablePresentedHandlerFunction = MtlCpp::Function<void(MTL::Drawable*)>;

	class Drawable : public NS::Referencing<Drawable>
	{
	public:
		void addPresentedHandler(MTL::DrawablePresentedHandler const block);
		void addPresentedHandler(MTL::DrawablePresentedHandlerFunction const& function);
...
_MTL_INLINE void
MTL::Drawable::addPresentedHandler(MTL::DrawablePresentedHandler const block)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(addPresentedHandler_), block);
}

_MTL_INLINE void
MTL::Drawable::addPresentedHandler(MTL::DrawablePresentedHandlerFunction const& function)
{
...
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(presentAfterMinimumDuration_),
	                          duration);
}

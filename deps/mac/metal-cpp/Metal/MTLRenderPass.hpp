...
namespace MTL
{
	...
	public:
		...
		void setResolveTexture(MTL::Texture const* resolveTexture);
		...
		void setTexture(MTL::Texture const* texture);
	...
	public:
		...
		void setObject(MTL::RenderPassColorAttachmentDescriptor const* attachment,
	...
	public:
		...
		void setSampleBuffer(MTL::CounterSampleBuffer const* sampleBuffer);
	...
	public:
		...
		void setObject(MTL::RenderPassSampleBufferAttachmentDescriptor const* attachment,
		               NS::UInteger attachmentIndex);
	};
	...
	public:
		...
		void setDepthAttachment(
			MTL::RenderPassDepthAttachmentDescriptor const* depthAttachment);

		void setImageblockSampleLength(NS::UInteger imageblockSampleLength);

		void
		setRasterizationRateMap(MTL::RasterizationRateMap const* rasterizationRateMap);
		...
		void setSamplePositions(MTL::SamplePosition const* positions, NS::UInteger count);

		void setStencilAttachment(
			MTL::RenderPassStencilAttachmentDescriptor const* stencilAttachment);
		...
		void setVisibilityResultBuffer(MTL::Buffer const* visibilityResultBuffer);
...
_MTL_INLINE MTL::ClearColor::ClearColor(double red, double green, double blue,
                                        double alpha)
: red(red)
, green(green)
, blue(blue)
...
_MTL_INLINE void
MTL::RenderPassAttachmentDescriptor::setResolveDepthPlane(NS::UInteger resolveDepthPlane)
{
...
_MTL_INLINE void
MTL::RenderPassAttachmentDescriptor::setResolveLevel(NS::UInteger resolveLevel)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setResolveLevel_), resolveLevel);
}

_MTL_INLINE void
MTL::RenderPassAttachmentDescriptor::setResolveSlice(NS::UInteger resolveSlice)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setResolveSlice_), resolveSlice);
}

_MTL_INLINE void
MTL::RenderPassAttachmentDescriptor::setResolveTexture(MTL::Texture const* resolveTexture)
{
...
_MTL_INLINE void
MTL::RenderPassAttachmentDescriptor::setStoreAction(MTL::StoreAction storeAction)
{
...
_MTL_INLINE void
MTL::RenderPassAttachmentDescriptor::setTexture(MTL::Texture const* texture)
{
...
_MTL_INLINE void
MTL::RenderPassColorAttachmentDescriptor::setClearColor(MTL::ClearColor clearColor)
{
...
_MTL_INLINE void
MTL::RenderPassStencilAttachmentDescriptor::setClearStencil(uint32_t clearStencil)
{
...
_MTL_INLINE void MTL::RenderPassColorAttachmentDescriptorArray::setObject(
	MTL::RenderPassColorAttachmentDescriptor const* attachment,
	NS::UInteger                                    attachmentIndex)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setObject_atIndexedSubscript_),
...
MTL::RenderPassSampleBufferAttachmentDescriptor::endOfFragmentSampleIndex() const
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(endOfFragmentSampleIndex));
}

_MTL_INLINE NS::UInteger
MTL::RenderPassSampleBufferAttachmentDescriptor::endOfVertexSampleIndex() const
{
	return Object::sendMessage<NS::UInteger>(this,
...
{
	return Object::sendMessage<MTL::CounterSampleBuffer*>(this,
	                                                      _MTL_PRIVATE_SEL(sampleBuffer));
}
...
_MTL_INLINE void MTL::RenderPassSampleBufferAttachmentDescriptor::setSampleBuffer(
	MTL::CounterSampleBuffer const* sampleBuffer)
{
...
_MTL_INLINE NS::UInteger
MTL::RenderPassSampleBufferAttachmentDescriptor::startOfVertexSampleIndex() const
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(startOfVertexSampleIndex));
}
...
_MTL_INLINE void MTL::RenderPassSampleBufferAttachmentDescriptorArray::setObject(
	MTL::RenderPassSampleBufferAttachmentDescriptor const* attachment,
	NS::UInteger                                           attachmentIndex)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setObject_atIndexedSubscript_),
	                          attachment, attachmentIndex);
...
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(defaultRasterSampleCount));
}
...
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(imageblockSampleLength));
}
...
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(renderTargetArrayLength));
}
...
_MTL_INLINE void
MTL::RenderPassDescriptor::setImageblockSampleLength(NS::UInteger imageblockSampleLength)
{
...
_MTL_INLINE void MTL::RenderPassDescriptor::setRasterizationRateMap(
	MTL::RasterizationRateMap const* rasterizationRateMap)
{
...
_MTL_INLINE void
MTL::RenderPassDescriptor::setRenderTargetHeight(NS::UInteger renderTargetHeight)
{
...
_MTL_INLINE void
MTL::RenderPassDescriptor::setRenderTargetWidth(NS::UInteger renderTargetWidth)
{
...
_MTL_INLINE void MTL::RenderPassDescriptor::setSamplePositions(
	MTL::SamplePosition const* positions, NS::UInteger count)
{
...
_MTL_INLINE void MTL::RenderPassDescriptor::setVisibilityResultBuffer(
	MTL::Buffer const* visibilityResultBuffer)
{
...
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setVisibilityResultType_),
...
_MTL_INLINE bool MTL::RenderPassDescriptor::supportColorAttachmentMapping() const
{
	return Object::sendMessageSafe<bool>(this,
	                                     _MTL_PRIVATE_SEL(supportColorAttachmentMapping));
}

_MTL_INLINE NS::UInteger MTL::RenderPassDescriptor::threadgroupMemoryLength() const
{
	return Object::sendMessage<NS::UInteger>(this,
	                                         _MTL_PRIVATE_SEL(threadgroupMemoryLength));
}
...
_MTL_INLINE MTL::Buffer* MTL::RenderPassDescriptor::visibilityResultBuffer() const
{
	return Object::sendMessage<MTL::Buffer*>(this,
	                                         _MTL_PRIVATE_SEL(visibilityResultBuffer));
}

_MTL_INLINE MTL::VisibilityResultType
			MTL::RenderPassDescriptor::visibilityResultType() const
{
	return Object::sendMessage<MTL::VisibilityResultType>(
		this, _MTL_PRIVATE_SEL(visibilityResultType));
}

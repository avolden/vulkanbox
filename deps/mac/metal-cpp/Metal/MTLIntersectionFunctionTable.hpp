...
namespace MTL
{
	...
	public:
		...
		void setFunction(MTL::FunctionHandle const* function, NS::UInteger index);
		void setFunctions(MTL::FunctionHandle const* const functions[], NS::Range range);
		...
		void setVisibleFunctionTable(MTL::VisibleFunctionTable const* functionTable,
		                             NS::UInteger                     bufferIndex);
		void
		setVisibleFunctionTables(MTL::VisibleFunctionTable const* const functionTables[],
...
_MTL_INLINE void
MTL::IntersectionFunctionTableDescriptor::setFunctionCount(NS::UInteger functionCount)
{
...
_MTL_INLINE void MTL::IntersectionFunctionTable::setBuffer(MTL::Buffer const* buffer,
                                                           NS::UInteger       offset,
                                                           NS::UInteger       index)
{
...
_MTL_INLINE void MTL::IntersectionFunctionTable::setFunction(
	MTL::FunctionHandle const* function, NS::UInteger index)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setFunction_atIndex_), function,
	                          index);
}

_MTL_INLINE void MTL::IntersectionFunctionTable::setFunctions(
	MTL::FunctionHandle const* const functions[], NS::Range range)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setFunctions_withRange_), functions,
	                          range);
}
	...
	MTL::IntersectionFunctionSignature signature, NS::UInteger index)
{
	Object::sendMessage<void>(
		this, _MTL_PRIVATE_SEL(setOpaqueCurveIntersectionFunctionWithSignature_atIndex_),
		signature, index);
}
	...
	MTL::IntersectionFunctionSignature signature, NS::Range range)
{
	Object::sendMessage<void>(
		this,
		_MTL_PRIVATE_SEL(setOpaqueCurveIntersectionFunctionWithSignature_withRange_),
		signature, range);
}
	...
	MTL::IntersectionFunctionSignature signature, NS::UInteger index)
{
	Object::sendMessage<void>(
		this,
		_MTL_PRIVATE_SEL(setOpaqueTriangleIntersectionFunctionWithSignature_atIndex_),
		signature, index);
}
...
_MTL_INLINE void MTL::IntersectionFunctionTable::setVisibleFunctionTables(
	MTL::VisibleFunctionTable const* const functionTables[], NS::Range bufferRange)
{
	Object::sendMessage<void>(this,

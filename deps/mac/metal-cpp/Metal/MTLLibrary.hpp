...
namespace MTL
{
	...
	_MTL_ENUM(NS::UInteger, LanguageVersion) {
		...
		LanguageVersion3_2 = 196610, LanguageVersion4_0 = 262144,
	};
	...
	using FunctionCompletionHandlerFunction =
		MtlCpp::Function<void(MTL::Function* pFunction, NS::Error* pError)>;
	...
	public:
		...
		ArgumentEncoder* newArgumentEncoder(NS::UInteger                     bufferIndex,
		                                    MTL::AutoreleasedArgument const* reflection);
	...
	public:
		...
		void
		setCompileSymbolVisibility(MTL::CompileSymbolVisibility compileSymbolVisibility);

		void setEnableLogging(bool enableLogging);

		void setFastMathEnabled(bool fastMathEnabled);

		void setInstallName(NS::String const* installName);

		void setLanguageVersion(MTL::LanguageVersion languageVersion);

		void setLibraries(NS::Array const* libraries);

		void setLibraryType(MTL::LibraryType libraryType);

		void setMathFloatingPointFunctions(
		...
		void setPreprocessorMacros(NS::Dictionary const* preprocessorMacros);
	...
	public:
		...
		Function* newFunction(NS::String const* functionName);
		Function* newFunction(NS::String const*                  name,
		                      MTL::FunctionConstantValues const* constantValues,
		                      NS::Error**                        error);
		void      newFunction(NS::String const*                  name,
		                      MTL::FunctionConstantValues const* constantValues,
		                      void (^completionHandler)(MTL::Function*, NS::Error*));
		void      newFunction(MTL::FunctionDescriptor const* descriptor,
		                      void (^completionHandler)(MTL::Function*, NS::Error*));
		Function* newFunction(MTL::FunctionDescriptor const* descriptor,
		                      NS::Error**                    error);
		void      newFunction(NS::String const*                             pFunctionName,
		                      MTL::FunctionConstantValues const*            pConstantValues,
		                      MTL::FunctionCompletionHandlerFunction const& completionHandler);
		void      newFunction(MTL::FunctionDescriptor const*                pDescriptor,
		                      MTL::FunctionCompletionHandlerFunction const& completionHandler);

		void
		newIntersectionFunction(MTL::IntersectionFunctionDescriptor const* descriptor,
		                        void (^completionHandler)(MTL::Function*, NS::Error*));
		Function* newIntersectionFunction(
			MTL::IntersectionFunctionDescriptor const* descriptor, NS::Error** error);
		void newIntersectionFunction(
			MTL::IntersectionFunctionDescriptor const*    pDescriptor,
			MTL::FunctionCompletionHandlerFunction const& completionHandler);

		FunctionReflection* reflectionForFunction(NS::String const* functionName);
...
_MTL_INLINE MTL::ArgumentEncoder* MTL::Function::newArgumentEncoder(
	NS::UInteger bufferIndex, MTL::AutoreleasedArgument const* reflection)
{
	return Object::sendMessage<MTL::ArgumentEncoder*>(
...
{
	return Object::sendMessage<NS::Integer>(this,
	                                        _MTL_PRIVATE_SEL(patchControlPointCount));
}
...
_MTL_INLINE void MTL::Function::setLabel(NS::String const* label)
{
...
_MTL_INLINE bool MTL::CompileOptions::allowReferencingUndefinedSymbols() const
{
	return Object::sendMessage<bool>(this,
	                                 _MTL_PRIVATE_SEL(allowReferencingUndefinedSymbols));
}
...
{
	return Object::sendMessage<MTL::LanguageVersion>(this,
...
_MTL_INLINE MTL::MathFloatingPointFunctions
			MTL::CompileOptions::mathFloatingPointFunctions() const
{
...
_MTL_INLINE MTL::Size MTL::CompileOptions::requiredThreadsPerThreadgroup() const
{
	return Object::sendMessage<MTL::Size>(
		this, _MTL_PRIVATE_SEL(requiredThreadsPerThreadgroup));
}
	...
	bool allowReferencingUndefinedSymbols)
{
	Object::sendMessage<void>(this,
	                          _MTL_PRIVATE_SEL(setAllowReferencingUndefinedSymbols_),
...
_MTL_INLINE void MTL::CompileOptions::setInstallName(NS::String const* installName)
{
...
_MTL_INLINE void MTL::CompileOptions::setLibraries(NS::Array const* libraries)
{
...
_MTL_INLINE void
MTL::CompileOptions::setOptimizationLevel(MTL::LibraryOptimizationLevel optimizationLevel)
{
...
_MTL_INLINE void
MTL::CompileOptions::setPreprocessorMacros(NS::Dictionary const* preprocessorMacros)
{
...
{
	return NS::Object::alloc<MTL::FunctionReflection>(
		_MTL_PRIVATE_CLS(MTLFunctionReflection));
}
...
_MTL_INLINE MTL::Function* MTL::Library::newFunction(NS::String const* functionName)
{
...
_MTL_INLINE MTL::Function* MTL::Library::newFunction(
	NS::String const* name, MTL::FunctionConstantValues const* constantValues,
	NS::Error** error)
{
	return Object::sendMessage<MTL::Function*>(
	...
	void (^completionHandler)(MTL::Function*, NS::Error*))
{
	Object::sendMessage<void>(
		this, _MTL_PRIVATE_SEL(newFunctionWithName_constantValues_completionHandler_),
		name, constantValues, completionHandler);
}

_MTL_INLINE void MTL::Library::newFunction(MTL::FunctionDescriptor const* descriptor,
                                           void (^completionHandler)(MTL::Function*,
                                                                     NS::Error*))
{
	Object::sendMessage<void>(
		this, _MTL_PRIVATE_SEL(newFunctionWithDescriptor_completionHandler_), descriptor,
		completionHandler);
}

_MTL_INLINE MTL::Function*
MTL::Library::newFunction(MTL::FunctionDescriptor const* descriptor, NS::Error** error)
{
	return Object::sendMessage<MTL::Function*>(
...
_MTL_INLINE void MTL::Library::newFunction(
	NS::String const* pFunctionName, MTL::FunctionConstantValues const* pConstantValues,
	MTL::FunctionCompletionHandlerFunction const& completionHandler)
{
	__block MTL::FunctionCompletionHandlerFunction blockCompletionHandler =
		completionHandler;
	newFunction(pFunctionName, pConstantValues,
	            ^(MTL::Function* pFunction, NS::Error* pError) {
				  blockCompletionHandler(pFunction, pError);
				});
}

_MTL_INLINE void
MTL::Library::newFunction(MTL::FunctionDescriptor const*                pDescriptor,
                          MTL::FunctionCompletionHandlerFunction const& completionHandler)
{
	__block MTL::FunctionCompletionHandlerFunction blockCompletionHandler =
		completionHandler;
...
_MTL_INLINE void MTL::Library::newIntersectionFunction(
	MTL::IntersectionFunctionDescriptor const* descriptor,
	void (^completionHandler)(MTL::Function*, NS::Error*))
{
	Object::sendMessage<void>(
...
{
	return Object::sendMessage<MTL::Function*>(
		this, _MTL_PRIVATE_SEL(newIntersectionFunctionWithDescriptor_error_), descriptor,
		error);
}
...
_MTL_INLINE MTL::FunctionReflection*
			MTL::Library::reflectionForFunction(NS::String const* functionName)
{
	return Object::sendMessage<MTL::FunctionReflection*>(
		this, _MTL_PRIVATE_SEL(reflectionForFunctionWithName_), functionName);
}

_MTL_INLINE void MTL::Library::setLabel(NS::String const* label)
{
	Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setLabel_), label);
}

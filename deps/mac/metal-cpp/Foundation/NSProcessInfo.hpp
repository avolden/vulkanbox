...
namespace NS
{
	...
	public:
		...
		void              setProcessName(String const* pString);
...
// The linker searches for these symbols in the Metal framework, be sure to link it in as
// well:
_NS_PRIVATE_DEF_CONST(NS::NotificationName,
                      ProcessInfoPerformanceProfileDidChangeNotification);
_NS_PRIVATE_DEF_CONST(NS::DeviceCertification,
...
_NS_INLINE void NS::ProcessInfo::setProcessName(String const* pString)
{
...
_NS_INLINE bool
NS::ProcessInfo::isOperatingSystemAtLeastVersion(OperatingSystemVersion version) const
{
...
_NS_INLINE void NS::ProcessInfo::disableAutomaticTermination(String const* pReason)
{
	Object::sendMessageSafe<void>(this, _NS_PRIVATE_SEL(disableAutomaticTermination_),
	                              pReason);
}

//-------------------------------------------------------------------------------------------------------------------------------------------------------------

_NS_INLINE void NS::ProcessInfo::enableAutomaticTermination(String const* pReason)
{
	Object::sendMessageSafe<void>(this, _NS_PRIVATE_SEL(enableAutomaticTermination_),
	                              pReason);
}
                                                 ...
                                                 void (^block)(void))
{
	Object::sendMessage<void>(
		this, _NS_PRIVATE_SEL(performActivityWithOptions_reason_usingBlock_), options,
		pReason, block);
}
...
_NS_INLINE void NS::ProcessInfo::performActivity(ActivityOptions                 options,
                                                 String const*                   pReason,
                                                 MtlCpp::Function<void()> const& function)
{
	__block MtlCpp::Function<void()> blockFunction = function;
...
_NS_INLINE void NS::ProcessInfo::performExpiringActivity(String const* pReason,
                                                         void (^block)(bool expired))
{
	Object::sendMessageSafe<void>(
		this, _NS_PRIVATE_SEL(performExpiringActivityWithReason_usingBlock_), pReason,
		block);
}
...
_NS_INLINE void NS::ProcessInfo::performExpiringActivity(
	String const* pReason, MtlCpp::Function<void(bool expired)> const& function)
{
	__block MtlCpp::Function<void(bool expired)> blockFunction = function;
...
{
	return Object::sendMessage<ProcessInfoThermalState>(this,
	                                                    _NS_PRIVATE_SEL(thermalState));
}
...
_NS_INLINE bool
NS::ProcessInfo::isDeviceCertified(DeviceCertification performanceTier) const
{
	return Object::sendMessageSafe<bool>(this, _NS_PRIVATE_SEL(isDeviceCertified_),
	                                     performanceTier);
}
...
_NS_INLINE bool
NS::ProcessInfo::hasPerformanceProfile(ProcessPerformanceProfile performanceProfile) const
{

...
namespace NS
{
	...
	using ObserverFunction = MtlCpp::Function<void(Notification*)>;
...
_NS_INLINE NS::Object* NS::NotificationCenter::addObserver(NS::NotificationName name,
                                                           Object* pObj, void* pQueue,
                                                           NS::ObserverBlock block)
{
	return NS::Object::sendMessage<Object*>(
		this, _NS_PRIVATE_SEL(addObserverName_object_queue_block_), name, pObj, pQueue,
		block);
}
